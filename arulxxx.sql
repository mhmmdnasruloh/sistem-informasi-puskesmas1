...
('000002', '282828', '2828282', 'tes', 'L', 'tegal', '06-12-2004', 'bekasi', 'BPJS'),
('000003', '2929', '-', 'udin', 'L', 'tegal', '11-11-2011', 'tegal', 'Umum');
...
('0002', '2023-12-01-0002', '000001', '2023-12-01', 'S-24', '2', 'setan', 'Orang Tua', 'Serang', 'BPJS', '28287188196112'),
('0003', '2023-12-01-0003', '000002', '2023-12-01', 'S-24', '2', 'tess', 'Saudara Kandung', 'bekasi', 'BPJS', '2828282'),
('0005', '2023-12-01-0005', '000003', '2023-12-01', 'K-12', '1', 'ud', 'Saudara Kandung', 'tegall', 'Umum', '-');
...
(1235, 'dokter', 'dokter@gmail.com', '$2y$04$wd0RcT6qJH3ysS8XVIF8xuZO1SFqiM/mZIXxGYrgQVl/61xImKulW', '', 3, 'y'),
(1236, 'apotek', 'apotek@gmail.com', '$2y$04$MbnWmFpPwMwXpfYKGOCrpelJ.4Yt4tOGy43MfYGu7Ca3CjywpIUwi', '', 4, 'y'),
(1237, 'pendaftaran', 'pendaftaran@gmail.com', '$2y$04$MA1JZEwjmlFDVy0RwlUTuuVydikWMVpOtg.6ot4V4Kf0Tm9y.WOK2', '', 5, 'y'),
(1238, 'pendaftaran', 'penda@gmail.com', '$2y$04$uUC3nB4HsPQvA9f4CcwyDuUmZq6VDkx34SZqJfThzBZmoGjB.lFGW', '', 5, 'y');
...
--
ALTER TABLE `tbl_perbaikan_gizi`
  MODIFY `id_gizi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tbl_user`
  MODIFY `id_users` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1240;

--
-- AUTO_INCREMENT untuk tabel `tbl_user_level`
--
ALTER TABLE `tbl_user_level`
  MODIFY `id_user_level` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
