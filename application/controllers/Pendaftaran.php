...
class Pendaftaran extends CI_Controller
{
   ...
   public function index()
    ...
    $sql_rekamedis    = "SELECT tr.*,pd.no_rawat,pd.tanggal_daftar 
        ...
        $pdf->Image('http://localhost/xxx/assets/foto_profil/logo-rs.jpg', 50, 5, 30);
        //$pdf->Image('', )
        // mencetak string 
        $pdf->Cell(45, 7, '', 0, 0, 'C');
        $pdf->Cell(230, 7, 'PUSKESMAS 666   x', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(30, 7, '', 0, 0, 'C');
        $pdf->Cell(270, 7, 'Jl. narogong no 6666', 0, 1, 'C');
        $pdf->Cell(70, 7, '', 0, 0, 'C');
        $pdf->Cell(190, 7, 'Telepon : 666. E-mail: 666@gmail.com', 0, 1, 'C');
...
function cetakbulan(){
    ...
    $sql_rekamedis    = "SELECT tr.*,pd.no_rawat,pd.tanggal_daftar 
        ...
        // mencetak string 
        $pdf->Cell(45, 7, '', 0, 0, 'C');
        $pdf->Cell(290, 7, 'PUSKESMAS bsi 666', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(30, 7, '', 0, 0, 'C');
        $pdf->Cell(330, 7, 'narogong 666', 0, 1, 'C');
        $pdf->Cell(70, 7, '', 0, 0, 'C');
        $pdf->Cell(250, 7, 'Telepon : (0267) 4218872. E-mail: 666', 0, 1, 'C');
  ...
  function cetakantrian($id){
        ...
        $tgl=date('Y/m/d');
        $pdf->Image('http://localhost/xxx/assets/foto_profil/latar-kartu.png',5,5,100,56);
        $pdf->Image('http://localhost/xxx/assets/foto_profil/logo-rs.jpg',10,9,10,10);
