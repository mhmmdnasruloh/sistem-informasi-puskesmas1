...
class Pasien extends CI_Controller
{
    ...
    function cetakkartu($id){
        ...
        $tgl=date('Y/m/d');
        $pdf->Image('http://localhost/xxx/assets/foto_profil/latar-kartu.jpg',5,5,100,56);
        $pdf->Image('http://localhost/xxx/assets/foto_profil/latar-kartu.jpg',106,5,100,56);
